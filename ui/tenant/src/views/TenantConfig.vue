  ...
  <a-row style="padding: 10px;">
    <a-col span="24">
      <a-table :dataSource="data" :columns="columns" :pagination="pagination" :loading="loading" size="small" bordered
               :rowKey="record => record.configGroup + record.configCode">
    ...
    methods: {
      ...
      change (text, record) {
        this.sourceData.forEach(item => {
          if (item.configCode === record.configCode && item.configUsage === record.configUsage && item.configGroup === record.configGroup) {
